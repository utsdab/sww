...
import maya_tools.utils as utils
...
class Base(object):
    ...
    for index in range(1, 11):
        _glow_pens[index] = [qg.QPen(qg.QColor(0, 255, 0, 12   * index), 1, qc.Qt.SolidLine),
                             qg.QPen(qg.QColor(0, 255, 0,  5   * index), 3, qc.Qt.SolidLine),
                             qg.QPen(qg.QColor(0, 255, 0,  2   * index), 5, qc.Qt.SolidLine),
                             qg.QPen(qg.QColor(0, 255, 0, 25.5 * index), 1, qc.Qt.SolidLine)]
